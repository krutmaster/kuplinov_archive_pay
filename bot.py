...
def start(message):
    ...
    #keyboard.add(telebot.types.KeyboardButton('ПОДПИСКА'))
    bot.send_message(id, f'Привет, {name}. Здесь ты можешь оплатить месяц доступа к каналу с перезаливами Куплинова в FullHD '
                         f'качестве в 60 кадров в секунду и с оригинальным битрейтом из ютуба.\nЦена - 100 рублей')
...
def pay(message):
    ...
    try:
        ...
        bot.send_message(id, f'Перейдите по ссылке доната https://www.donationalerts.com/r/krutmaster1 и отправьте 100 рублей, '
        ...
        bot.send_message(538231919, f'Pay:\n{e}')
...
def check_payment(message):
    ...
    try:
        ...
        bot.send_message(538231919, f'Check_pay:\n{e}')
...
def check_subs(message):
    ...
    if id == boss:
        ...
        try:
            ...
            bot.send_message(538231919, f'Check_subs:\n{e}')
...
def manual_check_subs(message):
    ...
    if id == boss:
        ...
        try:
            ...
            bot.send_message(538231919, f'Manual_heck_subs:\n{e}')
